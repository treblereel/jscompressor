...
import org.treblereel.javascript.compiler.processor.FileProcessor;
...
public class CompilerResource {
  ...
  @NonBlocking
  @WithSession
  public Uni<Response> read(@PathParam("hash") String filename) {
      return fileProcessor.fetchFileByFilename(filename);
  }
}
